...
<body>
 ...
 <div><center> <h1><?php echo $txt ?></center></h1><form name="test" method="get" action="home.php"> <input type="text" name="t1"><input type="submit"> <a href=""><img src="edit.jpg" height="30" width="30"></a></form>
